...
inputeraser.innerHTML= `<svg xmlns="http://www.w3.org/2000/svg" onclick="eliminartareas(${i})" width="16" height="16" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
